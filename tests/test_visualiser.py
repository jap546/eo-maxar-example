...
class TestPrePostEventStyleCallback:
    ...
    def test_pre_event_item_gets_blue(self) -> None:
        ...
        assert style_callback(pre_feature)["fillColor"] == _PRE_EVENT_COLOR
        assert style_callback(post_feature)["fillColor"] == _POST_EVENT_COLOR
